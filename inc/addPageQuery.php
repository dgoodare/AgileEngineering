<?php
    ...
    //Form Data from AJAX
    $data = $_POST['data'];
    $decodedDate = json_decode($data);
    $Title = $decodedDate['Title'];/*
    ...
    */
    ...
    mysqli_stmt_bind_param($stmt, 's'/*ssssssddddddddddddddddddd'*/, $Title/*,  $Description, $StreetAddress, $City, $Postcode, $Number, $Email, $Latitude, $Longitude, $Goals[0], $Goals[1], $Goals[2], $Goals[3], $Goals[4], $Goals[5], $Goals[6], $Goals[7], $Goals[8], $Goals[9], $Goals[10], $Goals[11], $Goals[12], $Goals[13], $Goals[14], $Goals[15], $Goals[16]*/);
